...
class SignUp extends _i45.PageRouteInfo<SignUpArgs> {
  SignUp({
    _i46.Key? key,
    _i47.AuthSourceRoute route = _i47.AuthSourceRoute.unknown,
...
class SignUpArgs {
  const SignUpArgs({
    this.key,
    this.route = _i47.AuthSourceRoute.unknown,
  });

  final _i46.Key? key;

  final _i47.AuthSourceRoute route;
